...
from xcpc_core.importer import AddFormalTeamParams, add_formal_team, import_formal_xcpcio_xlsx
from xcpc_core.importer.formal_store import raw_contest_basename, raw_contest_rel_path, raw_contest_path
...
@pytest.fixture
def import_repo(tmp_path, sample_xlsx, db_session) -> Path:
...
def test_add_formal_team_rejects_non_awarded_score(import_repo, db_session):
...
def test_add_formal_team_manual_unaffiliated_star(import_repo, db_session):
...
def test_add_formal_team_replaces_same_roster(import_repo, db_session):
    ...
    add_formal_team(params, repo_root=import_repo, session=db_session)
    result = add_formal_team(
