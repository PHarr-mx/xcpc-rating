...
from xcpc_core.importer.awards import assign_award, resolve_award_thresholds
from xcpc_core.importer.models import AwardThresholds, XcpcioParsedContest, XcpcioStandingRow
...
def _to_standing_scores(rows: list[XcpcioStandingRow]):
    from xcpc_core.importer.awards import StandingScore
